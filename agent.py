...
def _system_prompt() -> str:
    ...
    base = (
        ...
        "El registro de tiempo tiene dos modos: (1) bloques pasados con create_timeblock/list_timeblocks/etc., "
        "(2) sesión en vivo con start_tracking/stop_tracking/get_tracking_status — arranca un evento en Calendar ahora mismo "
        "y lo mantiene actualizado cada 5 minutos hasta que el usuario lo detenga. "
